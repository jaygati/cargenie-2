...
-- partners: no public access (admin-only, will be added later)
...
-- Insert sample car models for testing
INSERT INTO car_models (make, model, year_min, year_max, body_type, seats, fuel_type, mpg_city, mpg_highway, description, specs) VALUES
('Toyota', 'Camry', 2020, 2024, 'sedan', 5, 'gas', 28, 39, 'Reliable midsize sedan with excellent fuel economy and spacious interior. Perfect for families and commuters.', '{"horsepower": 203, "cargo_space": "15.1 cu ft", "safety_rating": 5}'::jsonb),
('Honda', 'CR-V', 2019, 2024, 'suv', 5, 'gas', 28, 34, 'Versatile compact SUV with great cargo space and Honda reliability. Ideal for active lifestyles.', '{"horsepower": 190, "cargo_space": "39.2 cu ft", "safety_rating": 5}'::jsonb),
('Ford', 'F-150', 2018, 2024, 'truck', 5, 'gas', 20, 26, 'America''s best-selling truck with impressive towing capacity and modern tech features.', '{"horsepower": 290, "towing_capacity": "8000 lbs", "bed_length": "6.5 ft"}'::jsonb),
('Tesla', 'Model 3', 2021, 2024, 'sedan', 5, 'electric', 0, 0, 'Premium electric sedan with cutting-edge technology and impressive range. Zero emissions.', '{"horsepower": 283, "range": "272 miles", "acceleration": "5.8s 0-60"}'::jsonb),
('Mazda', 'CX-5', 2020, 2024, 'suv', 5, 'gas', 25, 31, 'Sporty compact SUV with upscale interior and fun-to-drive dynamics.', '{"horsepower": 187, "cargo_space": "30.9 cu ft", "safety_rating": 5}'::jsonb)
